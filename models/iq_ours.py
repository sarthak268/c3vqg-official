...
class IQ(nn.Module):
    ...
    def __init__(self, vocab_size, max_len, hidden_size,
        ...
        self.question_encoder = EncoderRNN(vocab_size, max_len, hidden_size, num_categories, ques_encoder=True,
                                 input_dropout_p=input_dropout_p,
                                 dropout_p=dropout_p,
                                 n_layers=num_layers,
                                 bidirectional=False,
    ...
    def reconstruct_inputs_ours(self, image_features, category_features):
        ...
        t_mus, t_logvars = self.encode_into_t(image_features, category_features)
